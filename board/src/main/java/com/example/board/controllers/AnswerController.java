...
import com.example.board.services.AnswerService;
...
public class AnswerController {
  ...
  public String createAnswer(Model model, @PathVariable("id") Integer id, @Valid AnswerDto answerDto, BindingResult bindingResult) {
