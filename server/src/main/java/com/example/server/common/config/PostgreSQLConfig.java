...
public class PostgreSQLConfig implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        try (Connection connection = dataSource.getConnection()){
            ...
            // String sql = "CREATE TABLE SPRING_TEST(NO INTEGER NOT NULL, TEST_NAME VARCHAR(255), PRIMARY KEY (NO))";
            // statement.executeUpdate(sql);
        }

        // jdbcTemplate.execute("INSERT INTO SPRING_TEST VALUES (1, 'starbox7')");
    }
